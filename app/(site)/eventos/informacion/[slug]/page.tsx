...
export default function InfoEventoPage() {
  ...
  // <title> + description + Open Graph. Los scrapers de WhatsApp/Facebook no ejecutan JS:
  // esto cubre la pestana, Google y el canonical (ver docs/metadatos-og-eventos.md).
  usePageMeta(
    evento
      ? {
        title: evento.nombre,
        ...
        url: typeof window !== 'undefined' ? `${window.location.origin}${rutaEventoInformacion(evento)}` : undefined,
        type: 'article',
      }
      : null,
  );
