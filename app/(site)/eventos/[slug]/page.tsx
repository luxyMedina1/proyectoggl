...
import { buildEventoSlug, urlAbsolutaEvento, type EventoResuelto } from '../../../../utils/eventoSlug';
...
function DetalleEventoContent() {
  ...
  // <title> + description + Open Graph del evento. Los scrapers de WhatsApp/Facebook no
  // ejecutan JS, asi que esto cubre la pestana, Google y el canonical; la vista previa al
  // compartir necesita inyeccion en el servidor (docs/metadatos-og-eventos.md).
  usePageMeta(
    evento
      ? {
        title: funcionActiva?.nombre ? `${evento.nombre} - ${funcionActiva.nombre}` : evento.nombre,
        description:
          richTextToPlainText(evento.descripcion) ||
          [
        ...
        url: urlAbsolutaEvento(evento, funcionActiva),
        type: 'article',
      }
      : null,
  );
                          ...
                          <div className='grid grid-cols-8 divide-y gap-4'>
                            <div className='col-span-8 md:col-span-8'>
                              ...
                              <figure className='flex flex-wrap gap-3 items-center mt-2'>
                                <img className='aspect-3/2 object-contain w-6' width={60} height={40} src="/visa.png" alt="" />
                                <img className='aspect-3/2 object-contain w-6' width={60} height={40} src="/masterCard.png" alt="" />
                                <img className='aspect-3/2 object-contain w-6' width={60} height={40} src="/americanExpress.png" alt="" />
                                <img className='aspect-3/2 object-contain w-10' width={60} height={40} src="/carnet.png" alt="" />
                              </figure>
                            </div>
                            <div className='col-span-8 md:col-span-8 mt-2'>
                              ...
                              <figure className='flex flex-wrap gap-3 items-center'>
                                <img className='aspect-3/2 object-contain w-12' width={60} height={40} src="/BBVA.png" alt="" />
                                <img className='aspect-3/2 object-contain w-12' width={60} height={40} src="/santander.png" alt="" />
                                <img className='aspect-3/2 object-contain w-12' width={60} height={40} src="/hsbc.png" alt="" />
                                <img className='aspect-3/2 object-contain w-12' width={60} height={40} src="/scotiabank.png" alt="" />
                                <img className='aspect-3/2 object-contain w-12' width={60} height={40} src="/inbursa.png" alt="" />
                                <img className='aspect-3/2 object-contain w-12' width={60} height={40} src="/ixe.png" alt="" />
                              </figure>
                            </div>
                          </div>
                        </>
